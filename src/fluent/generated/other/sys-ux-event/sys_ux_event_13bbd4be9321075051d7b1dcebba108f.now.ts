...
Record({
    $id: Now.ID['13bbd4be9321075051d7b1dcebba108f'],
    table: 'sys_ux_event',
    data: {
        event_name: 'NAV_ITEM_SELECTED_RELAY_b677c87a93adc35051d7b1dcebba107f',
        label: 'Open page or URL Relay (Home default)',
        props: `[
    {
        "defaultValue": null,
        "fieldType": "string",
